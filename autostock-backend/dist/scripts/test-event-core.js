...
async function ensureAccounts(prisma) {
...
async function main() {
    ...
    const product = await prisma.product.create({
        data: {
            ...
            costPrice: new client_1.Prisma.Decimal(10),
            retailPrice: new client_1.Prisma.Decimal(15),
            wholesalePrice: new client_1.Prisma.Decimal(12),
            minStockAlert: 5,
            unit: 'pcs',
        },
    });
    ...
    const eventCore = new event_core_service_1.EventCoreService(prisma);
    ...
    if (!new client_1.Prisma.Decimal(movement.quantity).equals(50)) {
    ...
    if (!new client_1.Prisma.Decimal(balance.quantity).equals(50)) {
    ...
    const totalDebit = lines.reduce((s, l) => s.plus(l.debit), new client_1.Prisma.Decimal(0));
    const totalCredit = lines.reduce((s, l) => s.plus(l.credit), new client_1.Prisma.Decimal(0));
...
//# sourceMappingURL=test-event-core.js.map