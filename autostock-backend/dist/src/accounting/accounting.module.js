...
exports.AccountingModule = AccountingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [accounting_service_1.AccountingService, jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard, idempotency_interceptor_1.IdempotencyInterceptor],
    })
], AccountingModule);
